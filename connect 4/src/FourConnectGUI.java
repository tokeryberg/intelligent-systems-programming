...
public class FourConnectGUI extends JComponent implements MouseListener
{
	...
	bluePion = Toolkit.getDefaultToolkit().getImage("src/imgs/bluePion.png");
	arrow = Toolkit.getDefaultToolkit().getImage("src/imgs/arrow.png");
	arrow_active = Toolkit.getDefaultToolkit().getImage("src/imgs/arrow_active.png");
	background = Toolkit.getDefaultToolkit().getImage("src/imgs/background.png");
		
	border_left = Toolkit.getDefaultToolkit().getImage("src/imgs/border_left.png");
	border_right = Toolkit.getDefaultToolkit().getImage("src/imgs/border_right.png");
	border_top = Toolkit.getDefaultToolkit().getImage("src/imgs/border_top.png");
	border_bottom = Toolkit.getDefaultToolkit().getImage("src/imgs/border_bottom.png");
	corner_left_top = Toolkit.getDefaultToolkit().getImage("src/imgs/corner_left_top.png");
	corner_left_bottom = Toolkit.getDefaultToolkit().getImage("src/imgs/corner_left_bottom.png");
	corner_right_top = Toolkit.getDefaultToolkit().getImage("src/imgs/corner_right_top.png");
	corner_right_bottom = Toolkit.getDefaultToolkit().getImage("src/imgs/corner_right_bottom.png");
